...
const (
	TransportDocumentTypeBillOfLading TransportDocumentType = "BOL"
	TransportDocumentTypeSeaWaybill   TransportDocumentType = "SWB"
)

// All allowed values of TransportDocumentType enum
var AllowedTransportDocumentTypeEnumValues = []TransportDocumentType{
	TransportDocumentTypeBillOfLading,
	TransportDocumentTypeSeaWaybill,
}
