...
func NewShippingInstructionHeader(shippingInstructionID string, transportDocumentType common.TransportDocumentType, isShippedOnboardType bool, invoicePayableAt interface{}, isElectronic bool) *ShippingInstructionHeader {
	this := ShippingInstructionHeader{}
...
func (o *ShippingInstructionHeader) GetTransportDocumentType() common.TransportDocumentType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ShippingInstructionHeader) GetTransportDocumentTypeOk() (*common.TransportDocumentType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ShippingInstructionHeader) SetTransportDocumentType(v common.TransportDocumentType) {
...
func (o ShippingInstructionHeader) MarshalJSON() ([]byte, error) {
...
type NullableShippingInstructionHeader struct {
	value *ShippingInstructionHeader
	isSet bool
}

func (v NullableShippingInstructionHeader) Get() *ShippingInstructionHeader {
	return v.value
}

func (v *NullableShippingInstructionHeader) Set(val *ShippingInstructionHeader) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingInstructionHeader) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingInstructionHeader) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingInstructionHeader(val *ShippingInstructionHeader) *NullableShippingInstructionHeader {
	return &NullableShippingInstructionHeader{value: val, isSet: true}
}

func (v NullableShippingInstructionHeader) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingInstructionHeader) UnmarshalJSON(src []byte) error {
	v.isSet = true
