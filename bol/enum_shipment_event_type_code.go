...
// ShipmentEventTypeCode The status of the document in the process. Possible values are
// - RECE (Received)
// - DRFT (Drafted)
...
const (
	ShipmentEventTypeReceived        ShipmentEventTypeCode = "RECE" // Received
	ShipmentEventTypeDrafted         ShipmentEventTypeCode = "DRFT" // Drafted
	ShipmentEventTypePendingApproval ShipmentEventTypeCode = "PENA" // Pending Approval
	ShipmentEventTypePendingUpdate   ShipmentEventTypeCode = "PENU" // Pending Update
	ShipmentEventTypeRejected        ShipmentEventTypeCode = "REJE" // Rejected
	ShipmentEventTypeApproved        ShipmentEventTypeCode = "APPR" // Approved
	ShipmentEventTypeIssued          ShipmentEventTypeCode = "ISSU" // Issued
	ShipmentEventTypeSurrendered     ShipmentEventTypeCode = "SURR" // Surrendered
	ShipmentEventTypeSubmitted       ShipmentEventTypeCode = "SUBM" // Submitted
	ShipmentEventTypeVoid            ShipmentEventTypeCode = "VOID" // Void
	ShipmentEventTypeConfirmed       ShipmentEventTypeCode = "CONF" // Confirmed
)

// All allowed values of ShipmentEventTypeCode enum
var AllowedShipmentEventTypeCodeEnumValues = []ShipmentEventTypeCode{
	ShipmentEventTypeReceived,
	ShipmentEventTypeDrafted,
	ShipmentEventTypePendingApproval,
	ShipmentEventTypePendingUpdate,
	ShipmentEventTypeRejected,
	ShipmentEventTypeApproved,
	ShipmentEventTypeIssued,
	ShipmentEventTypeSurrendered,
	ShipmentEventTypeSubmitted,
	ShipmentEventTypeVoid,
	ShipmentEventTypeConfirmed,
}
